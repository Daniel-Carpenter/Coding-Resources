...
class PlaylistTest {
	...
	@Test
	void testAddSongs() throws IOException {
	...
	void testGetLongestSong() {
		...
		Playlist playlist = new Playlist();
		assertNull(playlist.getLongestSong());
		
		playlist.addSong(new Song(info0));
		assertEquals(info0, playlist.getLongestSong().toString());
		
		playlist.addSong(new Song(info2));
		assertEquals(info2, playlist.getLongestSong().toString());
		
		playlist.addSong(new Song(info1));
		assertEquals(info2, playlist.getLongestSong().toString());
		
		playlist.addSong(new Song(info5));
		assertEquals(info5, playlist.getLongestSong().toString());
		...
		assertEquals(info7, playlist.getLongestSong().toString());
	...
	@Test
	void testGetFavoriteArtist() {
		String info0 = "Open Mind; Blackfield; 3:51";
		String info1 = "Dark Matter; Porcupine Tree; 8:57";
		String info2 = "Sentimental; Porcupine Tree; 5:26";
		String info3 = "3 Years Older; Steven Wilson; 10:18";
		String info4 = "My Gift of Silence; Blackfield; 4:01";
		String info5 = "Hand Cannot Erase; Steven Wilson; 4:17";
		String info6 = "My Book of Regrets; Steven Wilson; 9:35";
		
		Playlist playlist = new Playlist();
		assertNull(playlist.getFavoriteArtist());
		
		playlist.addSong(new Song(info0));
		assertEquals("Blackfield", playlist.getFavoriteArtist());
		
		playlist.addSong(new Song(info1));
		assertEquals("Blackfield", playlist.getFavoriteArtist());
		
		playlist.addSong(new Song(info2));
		assertEquals("Porcupine Tree", playlist.getFavoriteArtist());
		...
		playlist.addSong(new Song(info6));
		assertEquals("Steven Wilson", playlist.getFavoriteArtist());
	}
